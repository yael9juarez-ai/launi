...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    description: "Bolsa de gomitas de sabores frutales variados (150g).",
    price: 30.00,
    category: "Golosinas",
  ...
  {
    id: "m12",
    name: "Gomitas de Mango (150g)",
    description: "Gomitas con un intenso sabor a mango (150g).",
    price: 30.00,
    category: "Golosinas",
  ...
  },
  {
    ...
    description: "Divertidas gomitas con forma de pinguino (150g).",
    price: 30.00,
    category: "Golosinas",
    imageUrl: "/images/pinguino.png",
    unit: "150g",
    recipe: [{ ingredientId: "i13", quantity: 150 }],
    nutrition: { calories: 450, protein: 2, fat: 0, carbs: 100 }
  },
